      ...
      <div className="w-[340px] border-r border-gray-100 flex flex-col bg-white">
        ...
        <div className="px-5 pt-5 pb-3">
          <div className="flex items-center justify-between mb-4">
            ...
            <button className="w-9 h-9 rounded-xl bg-[#4f6ef7] flex items-center justify-center text-white hover:bg-[#3b5de7] transition-colors cursor-pointer border-0">
            ...
            {users.map((u) => (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">{u.userType === 'worker' ? 'Ishchi' : 'Ish beruvchi'}</p>
                </div>
              </button>
            ))}
          </div>
          ...
          <>
            ...
            <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-100">
              ...
              <div className="flex items-center gap-2">
                <Link
                  to={`/profile/${selectedConversation.contact?.id}`}
                  className="px-4 py-2 rounded-xl border border-gray-200 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors no-underline"
                >
                  Profilini ko'rish
                </Link>
              </div>
            ...
            <div className="px-6 py-4 bg-white border-t border-gray-100">
              <div className="flex items-center gap-3">
                <button className="w-9 h-9 rounded-xl flex items-center justify-center text-gray-400 hover:bg-gray-50 transition-colors cursor-pointer border-0 bg-transparent">
